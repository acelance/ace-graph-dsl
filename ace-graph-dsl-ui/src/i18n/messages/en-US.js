export default {
  ...
  propertyPanel: {
    ...
    agentSpec: {
      ...
      mcpKeys: 'MCP Keys',
      mcpKeysHint: 'When Catalog is empty, type comma-separated MCP server keys.',
      mcpTree: 'MCP resources (tree)',
      mcpTreeHint: 'Check a server; expand to pick tools. No tool checked = all tools for that server. Empty when business Catalog is not implemented.',
